...
onMounted(() => {
    document.addEventListener("click", (ev: MouseEvent) => {
        if ((ev.target as HTMLDivElement).getAttribute("data-community") === null && isShow.value) {
            toggle()
        }
    })
})
        ...
        <div class="container">
            <div class="header__row">
                <div class="header__column header__nav">
                    ...
                    <p class="header__nav-link" id="community" @mousedown.prevent @click="toggle" ref="communityButton" data-community>
                        Сообщество
                        <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg" data-community>
